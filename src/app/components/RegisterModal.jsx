                  ...
                  <div>
                    ...
                    <div className="bg-white/5 rounded-2xl border border-white/10 divide-y divide-white/10">
                      <div className="grid grid-cols-2 gap-4 px-4 py-3 text-sm">
                        ...
                        <p className="text-white text-right">{form.full_name}</p>
                      </div>
                      <div className="grid grid-cols-2 gap-4 px-4 py-3 text-sm">
                        <p className="text-slate-400">Preferred Name</p>
                        <p className="text-white text-right">{form.preferred_name}</p>
                      </div>
                      <div className="grid grid-cols-2 gap-4 px-4 py-3 text-sm">
                        <p className="text-slate-400">Contact Number</p>
                        <p className="text-white text-right">{normalizePhilippineMobile(form.phone) || form.phone}</p>
                      </div>
                      <div className="grid grid-cols-2 gap-4 px-4 py-3 text-sm">
                        <p className="text-slate-400">Age / Gender</p>
                        <p className="text-white text-right">{form.age} / {form.gender}</p>
                      </div>
                      <div className="grid grid-cols-2 gap-4 px-4 py-3 text-sm">
                        <p className="text-slate-400">Home Church / Ministry</p>
                        <p className="text-white text-right">{form.church}</p>
                      </div>
                      <div className="grid grid-cols-2 gap-4 px-4 py-3 text-sm">
                        <p className="text-slate-400">Address</p>
                        <p className="text-white text-right">{form.address || '-'}</p>
                      </div>
                      <div className="grid grid-cols-2 gap-4 px-4 py-3 text-sm">
                        <p className="text-slate-400">Emergency Contact</p>
                        <p className="text-white text-right">{form.emergency_contact_name}</p>
                      </div>
                      <div className="grid grid-cols-2 gap-4 px-4 py-3 text-sm">
                        <p className="text-slate-400">Emergency Number</p>
                        <p className="text-white text-right">{normalizePhilippineMobile(form.emergency_contact_number) || form.emergency_contact_number}</p>
                      </div>
                      <div className="grid grid-cols-2 gap-4 px-4 py-3 text-sm">
                        <p className="text-slate-400">Relationship</p>
                        <p className="text-white text-right">{form.emergency_contact_relation}</p>
                      </div>
                    </div>
                  </div>
